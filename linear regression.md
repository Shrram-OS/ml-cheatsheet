...
Аналитическое решение - взять производную (наклон графика) $MSE$ и поделить на производную $w$ и приравнять к нулю (ноль - горизонтальная прямая на графике, это минимальное значение из-за того что наш график MSE - квадратическая функция и выглядит как "чаша" (парабола)). Потом из этой формулы вывести веса
